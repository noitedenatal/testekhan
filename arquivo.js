            ...
            if(features.autoAnswer && features.questionSpoof) {
                ...
                classToCheck.forEach(async (q) => {
                    ...
                    if(element && element.textContent === 'Mostrar resumo') { 
                        ...
                        // Espera um pouco antes de procurar o botão "A seguir: exercício"
                        await delay(1500);
    
                        // Busca e clica na opção "A seguir: exercício", se disponível
                        const nextExerciseButton = document.querySelector("button[aria-label='A seguir: exercício']");
                        if (nextExerciseButton) {
                            nextExerciseButton.click();
                            sendToast("➡️ Indo para o próximo exercício!", 3000);
                        }
                    }
                });
            }
